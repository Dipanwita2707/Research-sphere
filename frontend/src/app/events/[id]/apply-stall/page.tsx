...
export default function ApplyStallPage() {
  ...
  if (existingApplication) {
    const statusConfig = {
      ...
      withdrawn: { label: 'Withdrawn', color: 'text-gray-600', bg: 'bg-gray-50 border-gray-200', dot: 'bg-gray-400' },
    };
          ...
          <div className="bg-white dark:bg-gray-800 rounded-xl border border-gray-200 dark:border-gray-700 shadow-sm overflow-hidden">
              ...
              <div className="p-5 space-y-5">
                    ...
                    <div className="space-y-2">
                      {existingApplication.businessName && (
                        <div className="p-3 rounded-lg bg-gray-50 dark:bg-gray-700/50">
                          ...
                          <p className="text-sm font-medium text-gray-900 dark:text-white mt-0.5">{existingApplication.businessName}</p>
                        </div>
                      )}
                ...
                <div>
                  ...
                  <div className="flex flex-wrap gap-2">
                    ...
                    <span className={`inline-flex items-center gap-1.5 px-3 py-1.5 text-sm rounded-lg ${existingApplication.waterRequired ? 'bg-blue-50 dark:bg-blue-900/20 text-blue-700 dark:text-blue-300 border border-blue-200' : 'bg-gray-100 dark:bg-gray-700 text-gray-400 line-through'}`}>
            ...
            {activeTab === 'qr' && (
              <div className="p-6 flex flex-col items-center text-center">
                <div className="mb-4">
                  <h3 className="text-base font-semibold text-gray-900 dark:text-white mb-1">Customer Feedback QR Code</h3>
                ...
                {stallQrDataUrl ? (
                  <>
                    ...
                    <a
                      ...
                      className="inline-flex items-center gap-2 px-5 py-2.5 bg-violet-600 text-white text-sm font-medium rounded-xl hover:bg-violet-700 transition-colors shadow-sm"
                    >
                      ...
                      <div>
                        ...
                        <div className="space-y-3">
                          {feedbackData.feedback.map((fb) => {
                            ...
                            return (
                              <div key={fb.id} className="p-4 rounded-xl border border-gray-200 dark:border-gray-700 bg-gray-50 dark:bg-gray-700/50">
