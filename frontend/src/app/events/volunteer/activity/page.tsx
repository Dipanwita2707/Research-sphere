    ...
    <div className="min-h-screen bg-[#f8fafc] dark:bg-gray-900">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
          ...
          <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
            <div>
              <div className="flex items-center gap-3 mb-2">
                ...
                <h1 className="text-3xl font-bold text-ev-900 dark:text-white">Activity History</h1>
              </div>
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-6">
          {[
            { label: 'Total Scans', value: pagination.total, icon: History, color: 'from-ev-700 to-ev-800' },
            { label: 'Check-ins', value: stats.totalEntries, icon: LogIn, color: 'from-green-500 to-green-600' },
            { label: 'Check-outs', value: stats.totalExits, icon: LogOut, color: 'from-indigo-500 to-ev-900' },
        ...
        <div className={CARD + ' p-4 mb-6'}>
          <div className="flex flex-col sm:flex-row gap-3">
            ...
            <div className="flex gap-2">
              ...
              <button
                ...
                className={`px-4 py-2.5 border border-gray-300 dark:border-gray-600 rounded-lg flex items-center gap-2 text-sm transition-colors ${showFilters ? 'bg-ev-50 dark:bg-ev-900/20 border-[#b3cde0]' : 'hover:bg-gray-50 dark:hover:bg-gray-700'}`}
              >
          ...
          {/* Expanded Filters */}
          {showFilters && (
            <div className="mt-4 pt-4 border-t border-[#b3cde0] dark:border-gray-700 grid grid-cols-1 sm:grid-cols-3 gap-4">
              <div>
        ...
        {loading ? (
          ...
          <div className={CARD + ' p-12 text-center'}>
            ...
            {hasActiveFilters && (
              <button
                onClick={resetFilters}
                className="mt-4 px-4 py-2 text-sm bg-ev-700 text-white rounded-lg hover:bg-ev-800 transition"
              >
                Clear Filters
              </button>
            )}
                ...
                <div key={date}>
                  ...
                  <div className="space-y-3">
                    {dateEntries.map((entry) => (
                      <div
                        key={entry.id}
                        className={`${CARD} p-4 hover:shadow-ev-lg transition-shadow`}
                      >
