  ...
  const footerSections = [
    {
      ...
      links: [
        ...
        { name: 'My Work', href: '/my-work', isExternal: false },
  ...
  return (
    <footer className="relative bg-gradient-to-br from-charcoal via-brand-800 to-charcoal dark:from-charcoal dark:via-brand-800 dark:to-charcoal text-gray-300 pt-4 pb-2 mt-8 w-screen -ml-6 -mr-6">
      ...
      <div className="absolute inset-0 overflow-hidden">
        ...
        <div className="absolute -bottom-40 -left-40 w-80 h-80 bg-brand-600 rounded-full mix-blend-multiply filter blur-3xl opacity-10 animate-blob animation-delay-2000"></div>
      </div>
