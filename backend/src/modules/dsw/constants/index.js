...
const ClubChangeType = {
  ...
  VICE_CHAIRPERSON_CHANGE: 'vice_chairperson_change',
...
const DSWPermissions = {
  ...
  // Member Management
  ADD_MEMBER: ['vice_chairperson', 'faculty_facilitator'],
  REMOVE_MEMBER: ['vice_chairperson', 'faculty_facilitator'],
...
const ErrorMessages = {
  ...
  IMMUTABLE_FIELD_UPDATE: 'Cannot update immutable field without Noting approval',
  ...
  INVALID_VICE_CHAIRPERSON: 'Vice chairperson must be a student',
